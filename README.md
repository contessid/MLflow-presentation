...
| #   | Notebook                       | Topic                                           | Slides |
| --- | ------------------------------ | ----------------------------------------------- | ------ |
| 0   | `00_download_data.ipynb`       | Download & preprocess Jena Climate data         | —      |
| 1   | `01_experiment_tracking.ipynb` | Experiment tracking: params, metrics, artifacts | 7-8    |
| 2   | `02_optuna_tuning.ipynb`       | Hyperparameter tuning with Optuna + nested runs | 9      |
| 3   | `docker-compose.yml`           | Infrastructure: MLflow server + PostgreSQL      | 10-14  |
| 4   | `03_model_registry.ipynb`      | Model Registry: versioning & aliases            | 15-16  |
| 5   | `04_model_serving.ipynb`       | Model serving: REST API & Docker                | 17     |
| 6   | `05_production_setup.ipynb`    | Production: Supabase + Azure Blob               | —      |

> Run notebook **00** before the presentation to download the data. Notebooks 01-04 each work standalone as long as `data/jena_daily_temp.csv` exists.
